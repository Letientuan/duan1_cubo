...
public class NhanVien {
    ...
    public Object[] todataRow() {
        return new Object[]{maNV,tenNV,gioiTinh,ngaySinh,diaChi,sdt,email,dangNhap,chucVu,trangThai};
    }
   public Object[] getDataNV() {
        return new Object[]{ chucVu.getMaCV(),};
    }

    @Override
    public String toString() {
        return "NhanVien{" + "chucVu=" + chucVu + '}';
    }
