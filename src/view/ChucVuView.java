...
public class ChucVuView extends javax.swing.JFrame {
 ...
 private void loadTable() {
   ...
   private String getMa() {
    ...
    private void initComponents() {
        ...
        btnSua.setBackground(new java.awt.Color(153, 0, 153));
        ...
        btnXoaForm.setBackground(new java.awt.Color(153, 0, 153));
 ...
 try {
            ...
            if (JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn cập nhật thông tin sản phẩm này?") == JOptionPane.NO_OPTION) {
                return;
            }
            //update chuc vu
